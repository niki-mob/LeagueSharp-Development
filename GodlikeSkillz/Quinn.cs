...
namespace GodlikeSkillz
{
    internal class Quinn : Champion
    {
        ...
        {
            return HeroManager.Enemies.FirstOrDefault(enemy => enemy.NetworkId != target.NetworkId && enemy.Distance3D(target) < 600 && GetValue<StringList>("Blind" + enemy.ChampionName).SelectedIndex == 1) != null;
        }
