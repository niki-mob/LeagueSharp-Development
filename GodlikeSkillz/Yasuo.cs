...
namespace GodlikeSkillz
{
    internal class Yasuo : Champion
    {
        ...
        {
            return HeroManager.Allies.Where(tar => tar.Distance3D(target) < range).Any(tar => tar != null);
        }
        ...
        public void DashToLoc(Vector3 targetLoc, List<Obj_AI_Base> list , bool turrets)
        {
            ...
            foreach (var o in from o in list where Player.Distance3D(o) < E.Range && Player.ServerPosition.Distance(o.ServerPosition) > 45
